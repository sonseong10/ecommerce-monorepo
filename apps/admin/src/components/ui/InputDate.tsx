...
export function UiInputDate(props: IUiInputDateProps): JSX.Element {
  const { inputTextValue, changeValue } = useInputText(props.id, props.valid, props.init, props.change)
  return <InputDate change={changeValue} value={inputTextValue ? inputTextValue : ''} />
}
