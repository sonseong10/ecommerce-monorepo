...
export const createAppThunk = <Returned, ThunkArg = undefined>(
  ...
  return absCreateThunk<IState, IRes<Returned>, Returned, ThunkArg>(type, thunk)
}
...
export const createAppParamThunk = <ThunkArg = undefined>(
  ...
  return absCreateThunk<IState, IRes<undefined>, undefined, ThunkArg>(type, thunk)
}

export const createAppPageThunk = <Returned, Pageable = undefined, ThunkArg = undefined>(
  type: string,
  thunk: AsyncThunkPayloadCreator<IRes<Returned, Pageable>, ThunkArg, AsyncThunkConfig>,
): AsyncThunk<IRes<Returned, Pageable>, ThunkArg, AsyncThunkConfig> => {
  return absCreatePageThunk<IState, IRes<Returned, Pageable>, Returned, ThunkArg, Pageable>(type, thunk)
}
