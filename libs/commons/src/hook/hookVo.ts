...
/** 인풋 타입 정의 */
export type InputType = 'text' | 'number' | 'search' | 'email' | 'tel' | 'password' | 'checkbox' | 'file'
...
/** 이벤트 핸들러 정의 */
export type IUseEventHandler = (value: IUseInputEventParam) => Promise<void> | void
 ...
 * ref 를 추가로 받는다
 */
export interface IUserParamRef<T extends HTMLElement, Z extends HTMLElement> extends IUseParam<T> {
